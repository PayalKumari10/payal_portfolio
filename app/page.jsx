...
const Home = () => {
   const CV = "/resume/PayalKumari_Resume.pdf";
  ...
  return (
    <section className="h-full">
      <div className="container mx-auto h-full">
         ...
         {/* //xl:pt-8 xl:pb-24 */}
          ...
          <div className="text-center xl:text-left order-2 xl:order-none">
            ...
            <h1 className="h1 mb-6">
              Hello I am <br/> <span className="text-accent">Payal Kumari</span>
            </h1>
        ...
        <Stats/>
        {/* Footer */}
      <footer className="bg-primary py-2 mt-2">
        <div className="container mx-auto text-center text-white">
          &copy; {new Date().getFullYear()} All rights reserved by Payal Kumari
        </div>
      </footer>
    </section>
  );
